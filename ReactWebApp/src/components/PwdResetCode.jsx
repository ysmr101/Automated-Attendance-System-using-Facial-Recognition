...
export default function PwdResetCode({ showConfirmation, setShowConfirmation, email, userId }) {
  ...
  const ConfirmCode_URL = "/forgotPassword/confirmationCode";
    ...
    <div className="blurry-background">
      <div className="confirmation-box col-12 col-sm-10 col-md-6 col-xl-4 col-xxl-3">
        ...
        <h4 >Enter Confirmation Code
          <span className="close-button" onClick={handleClose}>X</span> {/* Add close button here */}
        </h4>
